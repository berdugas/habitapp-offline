...
describe("buildStripCells", () => {
  ...
  it("marks off-day cells correctly", () => {
    ...
    const cells = buildStripCells([], NO_MONDAYS, "2026-05-04", TODAY);
